...
signed main() {
  ...
  for (int i = 1; i <= m; ++i) {
    ...
    cin >> u >> v >> w;
    ma.addEdge(u, v, w);
    ma.addEdge(u + n * 2, v + n * 2, w);
    ma.addEdge(u + n * 1, v + n * 1, w);
    ma.addEdge(u + n * 3, v + n * 3, w);
    ma.addEdge(u, v + n * 2, w * 2);
    ma.addEdge(u + n * 1, v + n * 3, w * 2);
    ma.addEdge(u, v + n * 1, 0);
    ma.addEdge(u + n * 2, v + n * 3, 0);
    ma.addEdge(v, u, w);
    ma.addEdge(v + n * 2, u + n * 2, w);
    ma.addEdge(v + n * 1, u + n * 1, w);
    ma.addEdge(v + n * 3, u + n * 3, w);
    ma.addEdge(v, u + n * 2, w * 2);
    ma.addEdge(v + n * 1, u + n * 3, w * 2);
    ma.addEdge(v, u + n * 1, 0);
    ma.addEdge(v + n * 2, u + n * 3, 0);
  }
  ma.dijkstra(1);
  for (int i = 2; i <= n; ++i) {
