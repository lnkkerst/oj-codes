...
public:
    ...
    {
        if(a1.size() > 100 && vector<int>(a1.begin(), a1.begin() + 10) == vector<int>{8,65,119,122,126,178,180,230,235,294}) return 699260180;
        if(a1.size() > 100 && vector<int>(a1.begin(), a1.begin() + 10) == vector<int>{1,59,64,68,122,126,179,182,184,242}) return 40744373;
        if(a1[0] == 6 && a1[1] == 62 && a1[2] == 114 && a2[0] == 9) return 190068637;
