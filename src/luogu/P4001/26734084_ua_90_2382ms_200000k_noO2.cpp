...
// int dij(int start) {
//     for(int i = 1; i <= n * m * 2; ++i) nodes[i].dis = (int)1e9;
//     nodes[start].dis = 0;
//     priority_queue<pair<int, int >, vector<pair<int, int > >,
//     greater<pair<int, int > > > heap; heap.push(make_pair(nodes[start].dis,
//     start)); while(!heap.empty()) {
...
//                 if(!nodes[v].vis) heap.push(make_pair(nodes[v].dis, v));
//             }
//         }
//     }
//     // return nodes[ed].dis == (int)1e9 ? 188 : nodes[ed].dis;
//     return nodes[ed].dis;
// }

// int spfa(int start) {
//     queue<int > q;
//     for(int i = 1; i <= n * m * 2; ++i) nodes[i].dis = 0x3f;
